...
extension UIButton {
    ...
    private func positionLabelRespectToImage(_ title: String, position: UIView.ContentMode,
                                             spacing: CGFloat) {
        ...
        case .bottom:
            titleInsets = UIEdgeInsets(top: (imageSize.height * 0.5 + titleSize.height * 0.5 + spacing),
                                       left: -(imageSize.width), bottom: 0, right: 0)
